...
function badEventHandler(evtRoll) {
    switch (true) {
        ...
        case evtRoll >=43 && evtRoll < 51:
			...
			badEventChecker('frog', 'acrobatics');
			badEventChecker('deer', 'acrobatics');
			badEventChecker('bird', 'acrobatics');
			badEventChecker('bunny', 'acrobatics');
...
function matingSeason(animal){
	var a = Math.floor(getAnimalCount(count) * 0.2);
